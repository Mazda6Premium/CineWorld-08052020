...
class Film {
    ...
    init(name: String, id: String, index: Int, noComment: Int, noView: Int, noStar: Double, description: String, link: String, category: String) {
        self.name = name
        self.id = id
        self.index = index
    ...
    init(fromDict: [String: Any]) {
        ...
        self.noStar = fromDict["noStar"] as? Double ?? 0
